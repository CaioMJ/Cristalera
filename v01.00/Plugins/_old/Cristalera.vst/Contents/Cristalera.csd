...
vslider bounds(732, 68, 46, 336), channel("OutGain"), range(0, 2, 1, 1, 0.01), text("Output Gain"), trackerColour(0, 255, 0, 255), outlineColour(0, 0, 0, 50), textColour(255, 255, 255, 255)
